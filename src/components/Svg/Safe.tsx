...
const Safe = (props: Props) => {
  return (
    <Svg 
        ...
        viewBox="0 0 512 512"
    >
        <Path d="M42.67,64V256s0,170.66,213.33,234.66C469.33,426.67,469.33,256,469.33,256V64L256,21.34Z" fill={colors.white} />
        ...
        <Path d="M234.66,320a21.24,21.24,0,0,1-11.82-3.58l-64-42.67a21.33,21.33,0,1,1,23.67-35.5l48.05,32L324.94,157a21.33,21.33,0,0,1,32.78,27.31l-106.67,128A21.31,21.31,0,0,1,234.66,320Z" fill={colors.black} />
    </Svg>
  )
}
